...
SOPCINFO_FILE := F:/Pov_Led_FPGA/Qsys_system.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1830
SOPC_SYSID_FLAG += --sidp=0x1830
ELF_PATCH_FLAG  += --sidp 0x1830

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1514304766
SOPC_SYSID_FLAG += --timestamp=1514304766
ELF_PATCH_FLAG  += --timestamp 1514304766
