...
#
nios2-flash-programmer "../flash/Pov_Led_FPGA_epcs_flash.flash" --base=0x0 --epcs --sidp=0x1828 --id=0x0 --timestamp=1512645431 --device=1 --instance=0 '--cable=USB-Blaster on localhost [USB-0]' --program 
...
#
nios2-flash-programmer "../flash/Pov_Led_FPGA_epcs_flash_1_.flash" --base=0x0 --epcs --sidp=0x1828 --id=0x0 --timestamp=1512645431 --device=1 --instance=0 '--cable=USB-Blaster on localhost [USB-0]' --program 
